    ...
    <div>
      ...
      <section className="absolute w-full h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${heroBg})` }}>
        ...
        <div className="h-screen mt-16 flex flex-col text-white">
          ...
          <div className="flex md:justify-start md:pl-32 sm:justify-center z-30">
            <img
              src='./register_btn.png'
              className="w-52 h-10 sm:w-48 mt-10 cursor-pointer"
              onClick={() => navigate('/about')} // Example route to navigate
              alt="Register Now"
            />
          </div>
        </div>
